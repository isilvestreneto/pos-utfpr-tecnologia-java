...
abstract class Veiculo {
    ...
    public Veiculo(String placa, String marca, String modelo, String cor, float velocMax, int qtdRodas, int atrMotor1, int atrMotor2) {
        this.placa = placa;
        this.marca = marca;
        this.modelo = modelo;
        this.cor = cor;
        ...
        this.motor = new Motor(atrMotor1, atrMotor2);
    }
