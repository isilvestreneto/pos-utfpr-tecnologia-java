...
public class Janela {
    ...
    public static void construirFrame1() {
    ...
    public static void imprimirExcluirTodosPasseio(JFrame jfPasseio) {
        jfPasseio.dispose();
    ...
    public static void imprimirExcluirTodosCarga(JFrame jfPasseio) {
        jfPasseio.dispose();
    ...
    public static void atualizarTabelaPasseio(DefaultTableModel tableModel) {
    ...
    public static void imprimirTodosPasseio(DefaultTableModel tableModel) {
    ...
    public static void imprimirTodosCarga(DefaultTableModel tableModel) {
    ...
    public static void excluirTodosPasseio(JFrame frame, DefaultTableModel tableModel) {
    ...
    public static void excluirTodosCarga(JFrame frame, DefaultTableModel tableModel) {
        int confirm = JOptionPane.showConfirmDialog(frame, "Tem certeza que deseja excluir todos os veículos?", "Confirmação", JOptionPane.YES_NO_OPTION);
        if (confirm == JOptionPane.YES_OPTION) {
            if (BDVeiculos.getListaCarga().isEmpty()) {
                JOptionPane.showMessageDialog(frame, "Não há veículo para excluir", "Erro", JOptionPane.ERROR_MESSAGE);
    ...
    public static void consultarExcluirPorPlacaPasseio(JFrame jfPasseio) {
        jfPasseio.dispose();
    ...
    public static void consultarExcluirPorPlacaCarga(JFrame jfCarga) {
        jfCarga.dispose();
    ...
    public static void atualizarTabelaCarga(DefaultTableModel tableModel) {
        tableModel.setRowCount(0);
